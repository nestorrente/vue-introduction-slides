...
<script lang="ts">
	...
	@Component({
		components: {CommonSlideMarkup}
	})
	export default class CoreFeatures extends Vue {

		private features1: string[] = [
			'Components',
			'Virtual DOM',
			'Templates',
			'Render functions',
